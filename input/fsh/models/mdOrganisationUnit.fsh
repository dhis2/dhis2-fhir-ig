...
* leaf 1..1 boolean "Is this is leaf in the organisation unit tree"
...
* attributeValues 0..* MDAttributeValue "additional attributes that are in this organisation unit"
